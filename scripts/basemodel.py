...
def train_base_model():
    ...
    train_generator = train_datagen.flow_from_directory(
        'datasets/chest_xray/train',  # Path to training data
    ...
    validation_generator = val_datagen.flow_from_directory(
        'datasets/chest_xray/val',  # Path to validation data
        # Resize images to 150x150 for the model
        target_size=(150, 150),
        batch_size=16,
        color_mode='grayscale',
    ...
    plt.savefig('plots/baseplot2.png')
    plt.show()
    ...
    for i in range(9):
        ...
        plt.title(
            f"Actual: {test_labels[i]}, Predicted: {predicted_labels[i]}")
        plt.axis("off")
    plt.savefig('plots/baseplot1.png')

    model.save('scripts/base_model.h5')
